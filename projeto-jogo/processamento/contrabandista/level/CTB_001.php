<?php
  ...
  if($valorDado == 20) {
    $redirecionamento = "../final/CTB_001F.php";
  }
  else if($valorDado <= 12) {
    $redirecionamento = "CTB_0011.php";
  }
  else {
    $redirecionamento = "CTB_0012.php";
  }

  $storyFile = fopen(CTB_1, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_1));
  fclose($storyFile);
?>
